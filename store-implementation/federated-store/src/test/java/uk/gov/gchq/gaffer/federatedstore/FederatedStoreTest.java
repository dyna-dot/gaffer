...
public class FederatedStoreTest {
  ...
  private static final String PATH_ACC_STORE_PROPERTIES_1 =
      "properties/singleUseMockAccStore.properties";
  private static final String PATH_ACC_STORE_PROPERTIES_2 =
      "properties/singleUseMockAccStore.properties";
  private static final String PATH_ACC_STORE_PROPERTIES_ALT =
      "properties/singleUseMockAccStoreAlt.properties";
  private static final String PATH_BASIC_ENTITY_SCHEMA_JSON =
      "schema/basicEntitySchema.json";
  private static final String PATH_ENTITY_A_SCHEMA_JSON =
      "schema/entityASchema.json";
  private static final String PATH_ENTITY_B_SCHEMA_JSON =
      "schema/entityBSchema.json";
  private static final String PATH_BASIC_EDGE_SCHEMA_JSON =
      "schema/basicEdgeSchema.json";
  private static final String EXCEPTION_NOT_THROWN = "exception not thrown";
  public static final String UNUSUAL_KEY = "unusualKey";
  public static final String KEY_DOES_NOT_BELONG =
      UNUSUAL_KEY + " was added to " + ID_PROPS_ACC_2 +
  ...
  private static final String INVALID_CACHE_SERVICE_CLASS_STRING =
      "uk.gov.gchq.invalid";
  private static final String CACHE_SERVICE_NAME = "federatedStoreGraphs";
  public static final String PATH_INCOMPLETE_SCHEMA =
      "/schema/edgeX2NoTypesSchema.json";
  public static final String PATH_INCOMPLETE_SCHEMA_PART_2 =
      "/schema/edgeTypeSchema.json";
  ...
  public void setUp() throws Exception {
    ...
    federatedProperties.set(HashMapCacheService.STATIC_CACHE,
                            String.valueOf(true));

    clearLibrary();
    library = new HashMapGraphLibrary();
    library.addProperties(ID_PROPS_ACC_1,
                          getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_1));
    library.addProperties(ID_PROPS_ACC_2,
                          getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_2));
    library.addProperties(ID_PROPS_ACC_ALT,
    ...
    library.addSchema(ID_SCHEMA_ENTITY,
                      getSchemaFromPath(PATH_BASIC_ENTITY_SCHEMA_JSON));
  ...
  public void tearDown() throws Exception {
    assertEquals("Library has changed: " + ID_PROPS_ACC_1,
                 library.getProperties(ID_PROPS_ACC_1),
                 getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_1));
    assertEquals("Library has changed: " + ID_PROPS_ACC_2,
                 library.getProperties(ID_PROPS_ACC_2),
                 getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_2));
    assertEquals("Library has changed: " + ID_PROPS_ACC_ALT,
                 library.getProperties(ID_PROPS_ACC_ALT),
                 getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_ALT));
    assertEquals(
        "Library has changed: " + ID_SCHEMA_EDGE,
        new String(library.getSchema(ID_SCHEMA_EDGE).toJson(false),
                   CommonConstants.UTF_8),
        new String(getSchemaFromPath(PATH_BASIC_EDGE_SCHEMA_JSON).toJson(false),
                   CommonConstants.UTF_8));
    assertEquals(
        "Library has changed: " + ID_SCHEMA_ENTITY,
        new String(library.getSchema(ID_SCHEMA_ENTITY).toJson(false),
                   CommonConstants.UTF_8),
        new String(
            getSchemaFromPath(PATH_BASIC_ENTITY_SCHEMA_JSON).toJson(false),
            CommonConstants.UTF_8));
    clearLibrary();
    clearCache();
  }
  ...
  @Test
  public void shouldNotAllowOverwritingOfGraphWithinFederatedScope()
      throws Exception {
    // Given
  ...
  @Test
  public void
  shouldThrowAppropriateExceptionWhenHandlingAnUnsupportedOperation() {
    // Given
  ...
  public void shouldAlwaysReturnSupportedTraits() throws Exception {
    ...
    // When
    addGraphWithPaths(ACC_ID_2, PATH_ACC_STORE_PROPERTIES_ALT,
                      PATH_BASIC_ENTITY_SCHEMA_JSON);
  ...
  public void shouldUpdateSchemaWhenNewGraphIsAdded() throws Exception {
    // Given
    addGraphWithPaths(ACC_ID_1, PATH_ACC_STORE_PROPERTIES_ALT,
                      PATH_BASIC_ENTITY_SCHEMA_JSON);
  ...
  public void shouldFailWithIncompleteSchema() throws Exception {
    ...
    try {
      addGraphWithPaths(ACC_ID_1, PATH_ACC_STORE_PROPERTIES_ALT,
                        PATH_INCOMPLETE_SCHEMA);
      fail(EXCEPTION_NOT_THROWN);
    } catch (final Exception e) {
      assertContains(e, FederatedAddGraphHandler.ERROR_ADDING_GRAPH_GRAPH_ID_S,
                     ACC_ID_1);
    }
  }
  ...
  public void shouldTakeCompleteSchemaFromTwoFiles() throws Exception {
    ...
    int before = store.getGraphs(blankUser, null).size();
    addGraphWithPaths(ACC_ID_1, PATH_ACC_STORE_PROPERTIES_ALT,
                      PATH_INCOMPLETE_SCHEMA, PATH_INCOMPLETE_SCHEMA_PART_2);
  ...
  public void shouldCombineTraitsToMin() throws Exception {
    // Given
    final GetTraits getTraits =
        new GetTraits.Builder().currentTraits(true).build();
    ...
    store.execute(new AddGraph.Builder()
                      ...
                      .isPublic(true)
                      .graphId(ACC_ID_1)
                      .storeProperties(StoreProperties.loadStoreProperties(
                          "/properties/singleUseMockAccStore.properties"))
                      .build(),
    ...
    store.execute(
        new AddGraph.Builder()
            ...
            .graphId(MAP_ID_1)
            .storeProperties(
                new FederatedGetTraitsHandlerTest.TestStorePropertiesImpl())
            .build(),
        new Context(testUser()));
    ...
    // Then
    assertNotEquals(
        SingleUseAccumuloStore.TRAITS,
        new HashSet<>(Arrays.asList(
            StoreTrait.INGEST_AGGREGATION, StoreTrait.PRE_AGGREGATION_FILTERING,
            StoreTrait.POST_AGGREGATION_FILTERING, StoreTrait.TRANSFORMATION,
            StoreTrait.POST_TRANSFORMATION_FILTERING,
            StoreTrait.MATCHED_VERTEX)));
    assertEquals(StoreTrait.ALL_TRAITS, before);
    assertEquals(Sets.newHashSet(TRANSFORMATION, PRE_AGGREGATION_FILTERING,
                                 POST_AGGREGATION_FILTERING,
                                 POST_TRANSFORMATION_FILTERING, ORDERED,
                                 MATCHED_VERTEX),
                 afterAcc);
    assertEquals(Sets.newHashSet(TRANSFORMATION, PRE_AGGREGATION_FILTERING,
                                 POST_AGGREGATION_FILTERING,
                                 POST_TRANSFORMATION_FILTERING, MATCHED_VERTEX),
                 afterMap);
  }
  ...
  public void shouldAddGraphFromLibrary() throws Exception {
    // Given
    library.add(ACC_ID_2, library.getSchema(ID_SCHEMA_ENTITY),
                library.getProperties(ID_PROPS_ACC_2));

    // When
    final int before = store.getGraphs(blankUser, null).size();
    store.execute(new AddGraph.Builder().graphId(ACC_ID_2).build(),
  ...
  public void shouldAddGraphWithPropertiesFromGraphLibrary() throws Exception {
    ...
    assertTrue(
        library.getProperties(ID_PROPS_ACC_ALT)
            .equals(getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_ALT)));
  }
  ...
  public void shouldAddGraphWithSchemaFromGraphLibrary() throws Exception {
    ...
    assertEquals(1, store.getGraphs(blankUser, null).size());
    assertTrue(
        library.getSchema(ID_SCHEMA_ENTITY)
            .toString()
            .equals(
                getSchemaFromPath(PATH_BASIC_ENTITY_SCHEMA_JSON).toString()));
  }

  @Test
  public void shouldAddGraphWithPropertiesAndSchemaFromGraphLibrary()
      throws Exception {
    // When
    addGraphWithIds(ACC_ID_2, ID_PROPS_ACC_ALT, ID_SCHEMA_ENTITY);
    ...
    assertEquals(getSchemaFromPath(PATH_BASIC_ENTITY_SCHEMA_JSON).toString(),
                 graph.getSchema().toString());
    assertEquals(getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_ALT),
                 graph.getStoreProperties());
  }

  @Test
  public void shouldAddGraphWithPropertiesFromGraphLibraryOverridden()
      throws Exception {
    // Given
    assertFalse(KEY_DOES_NOT_BELONG,
                library.getProperties(ID_PROPS_ACC_2).containsKey(UNUSUAL_KEY));
    ...
    // Then
    assertEquals(1, store.getGraphs(blankUser, null).size());
    assertTrue(store.getGraphs(blankUser, null)
                   .iterator()
                   .next()
                   .getStoreProperties()
    ...
    assertTrue(store.getGraphs(blankUser, null)
                   ...
                   .getStoreProperties()
                   .getProperties()
                   .getProperty(UNUSUAL_KEY) != null);
  }

  @Test
  public void shouldAddGraphWithSchemaFromGraphLibraryOverridden()
      throws Exception {
  ...
  @Test
  public void shouldAddGraphWithPropertiesAndSchemaFromGraphLibraryOverridden()
      throws Exception {
    // Given
    assertFalse(KEY_DOES_NOT_BELONG,
                library.getProperties(ID_PROPS_ACC_2).containsKey(UNUSUAL_KEY));
  ...
  public void shouldNotAllowOverridingOfKnownGraphInLibrary() throws Exception {
    // Given
    library.add(ACC_ID_2, getSchemaFromPath(PATH_BASIC_ENTITY_SCHEMA_JSON),
                getPropertiesFromPath(PATH_ACC_STORE_PROPERTIES_ALT));
    ...
    try {
      ...
      assertContains(
          e.getCause(),
          "Graph: " + ACC_ID_2 +
              " already exists so you cannot use a different StoreProperties");
    }
    ...
    try {
      ...
      assertContains(
          e.getCause(),
          "Graph: " + ACC_ID_2 +
              " already exists so you cannot use a different Schema");
    }
  }
  ...
  public void shouldFederatedIfUserHasCorrectAuths() throws Exception {
    // Given
    store.addGraphs(
        GRAPH_AUTHS, null, false,
        new GraphSerialisable.Builder()
            .config(new GraphConfig.Builder().graphId(ACC_ID_2).build())
    ...
    final CloseableIterable<? extends Element> elements = store.execute(
        new GetAllElements(), new Context(new User.Builder()
    ...
    final CloseableIterable<? extends Element> elements2 = store.execute(
        new GetAllElements(), new Context(new User.Builder()
                                              .userId(blankUser.getUserId())
                                              .opAuths("x")
                                              .build()));
  ...
  public void shouldReturnSpecificGraphsFromCSVString() throws Exception {
    // Given
    final List<Collection<GraphSerialisable>> graphLists =
        populateGraphs(1, 2, 4);
    ...
    // When
    final Collection<Graph> returnedGraphs =
        store.getGraphs(blankUser, "mockGraphId1,mockGraphId2,mockGraphId4");
  ...
  @Test
  public void shouldReturnEnabledByDefaultGraphsForNullString()
      throws Exception {
    // Given
    populateGraphs();
    ...
    // Then
    final Set<String> graphIds = returnedGraphs.stream()
                                     .map(Graph::getGraphId)
                                     .collect(Collectors.toSet());
    assertEquals(
        Sets.newHashSet("mockGraphId0", "mockGraphId2", "mockGraphId4"),
        graphIds);
  }

  @Test
  public void shouldReturnNotReturnEnabledOrDisabledGraphsWhenNotInCsv()
      throws Exception {
    // Given
    populateGraphs();
    ...
    // When
    final Collection<Graph> returnedGraphs =
        store.getGraphs(blankUser, "mockGraphId0,mockGraphId1");
  ...
  public void shouldReturnGraphsWithLeadingCommaString() throws Exception {
    ...
    // When
    final Collection<Graph> returnedGraphs =
        store.getGraphs(blankUser, ",mockGraphId2,mockGraphId4");
  ...
  public void shouldAddGraphIdWithAuths() throws Exception {
    ...
    fedGraph.execute(
        new AddGraph.Builder().graphAuths("auth").graphId(ACC_ID_2).build(),
        blankUser);
    ...
    fedGraph.execute(
        new AddElements.Builder()
            .input(
                new Entity.Builder().group("BasicEntity").vertex("v1").build())
            .build(),
        blankUser);

    final CloseableIterable<? extends Element> elements = fedGraph.execute(
        new GetAllElements(),
        new User.Builder().userId(TEST_USER + "Other").opAuth("auth").build());

    final CloseableIterable<? extends Element> elements2 = fedGraph.execute(
        new GetAllElements(),
        new User.Builder().userId(TEST_USER + "Other").opAuths("x").build());
    assertEquals(0, Iterables.size(elements2));
  ...
  @Test
  public void shouldThrowWithPropertiesErrorFromGraphLibrary()
      throws Exception {
    Builder schema = new Builder();
    for (String path : new String[] {PATH_BASIC_EDGE_SCHEMA_JSON}) {
      schema.merge(getSchemaFromPath(path));
    ...
    Mockito.when(mockLibrary.getProperties(ID_PROPS_ACC_2))
  ...
  public void shouldThrowWithSchemaErrorFromGraphLibrary() throws Exception {
    ...
    final GraphLibrary mockLibrary = Mockito.mock(GraphLibrary.class);
    final String error = "test Something went wrong";
    Mockito.when(mockLibrary.getSchema(ID_SCHEMA_ENTITY))
        .thenThrow(new IllegalArgumentException(error));
    store.setGraphLibrary(mockLibrary);
    clearCache();
    store.initialise(FEDERATED_STORE_ID, null, federatedProperties);
    ...
    try {
      store.execute(new AddGraph.Builder()
                        .graphId(ACC_ID_2)
                        .storeProperties(getPropertiesFromPath(
                            PATH_ACC_STORE_PROPERTIES_ALT))
                        .isPublic(true)
                        .parentSchemaIds(Lists.newArrayList(ID_SCHEMA_ENTITY))
                        .build(),
                    userContext);
  ...
  public void shouldReturnASingleGraph() throws Exception {
    ...
    // When
    final Collection<Graph> returnedGraphs =
        store.getGraphs(blankUser, "mockGraphId1");
  ...
  private List<Graph>
  toGraphs(final Collection<GraphSerialisable> graphSerialisables) {
    return graphSerialisables.stream()
        .map(GraphSerialisable::getGraph)
  ...
  public void shouldReuseGraphsAlreadyInCache() throws Exception {
    ...
    GraphSerialisable graphToAdd =
        new GraphSerialisable.Builder()
            .config(new GraphConfig(ACC_ID_2))
            .properties(StreamUtil.openStream(FederatedStoreTest.class,
                                              PATH_ACC_STORE_PROPERTIES_ALT))
            .schema(StreamUtil.openStream(FederatedStoreTest.class,
                                          PATH_BASIC_EDGE_SCHEMA_JSON))
            .build();
    ...
    assertTrue(CacheServiceLoader.getService()
                   .getAllKeysFromCache(CACHE_SERVICE_NAME)
                   .contains(ACC_ID_2));
    assertTrue(CacheServiceLoader.getService()
                   .getAllKeysFromCache(CACHE_SERVICE_NAME)
                   .contains(ACC_ID_2));
    ...
    assertTrue("Keys: " +
                   CacheServiceLoader.getService().getAllKeysFromCache(
                       CACHE_SERVICE_NAME) +
                   " did not contain " + ACC_ID_2,
  ...
  @Test
  public void
  shouldNotThrowExceptionWhenInitialisedWithNoCacheClassInProperties()
      throws StoreException {
    // Given
    federatedProperties = new FederatedStoreProperties();
  ...
  public void shouldAddMultipleGraphsToCache() throws Exception {
    ...
    // When
    store.addGraphs(
        null, StoreUser.TEST_USER, false,
        graphsToAdd.toArray(new GraphSerialisable[graphsToAdd.size()]));
  ...
  @Test
  public void shouldAddAGraphRemoveAGraphAndBeAbleToReuseTheGraphId()
      throws Exception {
    // Given
    // When
    addGraphWithPaths(ACC_ID_2, PATH_ACC_STORE_PROPERTIES_ALT,
                      PATH_BASIC_ENTITY_SCHEMA_JSON);
    store.execute(new RemoveGraph.Builder().graphId(ACC_ID_2).build(),
                  userContext);
    addGraphWithPaths(ACC_ID_2, PATH_ACC_STORE_PROPERTIES_ALT,
                      PATH_BASIC_EDGE_SCHEMA_JSON);
    ...
    final Collection<Graph> graphs =
        store.getGraphs(userContext.getUser(), ACC_ID_2);
    assertEquals(1, graphs.size());
    JsonAssert.assertEquals(
        JSONSerialiser.serialise(Schema.fromJson(
            StreamUtil.openStream(getClass(), PATH_BASIC_EDGE_SCHEMA_JSON))),
        JSONSerialiser.serialise(graphs.iterator().next().getSchema()));
  }

  @Test
  public void
  shouldNotAddGraphToLibraryWhenReinitialisingFederatedStoreWithGraphFromCache()
      throws Exception {
    // Check cache is empty
    federatedProperties.setCacheProperties(CACHE_SERVICE_CLASS_STRING);
    assertNull(CacheServiceLoader.getService());
  ...
  private boolean checkUnexpected(final Collection<Graph> unexpectedGraphs,
                                  final Collection<Graph> returnedGraphs) {
  ...
  private List<Collection<GraphSerialisable>>
  populateGraphs(final int... expectedIds) throws Exception {
    ...
    for (int i = 0; i < 6; i++) {
      GraphSerialisable tempGraph =
          new GraphSerialisable.Builder()
              .config(
                  new GraphConfig.Builder().graphId("mockGraphId" + i).build())
              .properties(StreamUtil.openStream(FederatedStoreTest.class,
                                                PATH_ACC_STORE_PROPERTIES_ALT))
              .schema(StreamUtil.openStream(FederatedStoreTest.class,
                                            PATH_BASIC_ENTITY_SCHEMA_JSON))
      ...
      store.addGraphs(Sets.newHashSet(ALL_USERS), null, true, disabledByDefault,
                      tempGraph);
  ...
  private Set<Element> getElements()
    ...
    CloseableIterable<? extends Element> elements = store.execute(
  ...
  private void assertContains(final Throwable e, final String format,
                              final String... s) {
    final String expectedStr = String.format(format, s);
    boolean contains = e.getMessage().contains(expectedStr);
    assertTrue("\"" + e.getMessage() + "\" does not contain string \"" +
                   expectedStr + "\"",
               contains);
  }

  private void addGraphWithIds(final String graphId, final String propertiesId,
  ...
  private void addGraphWithPaths(final String graphId,
  ...
  getPropertiesFromPath(final String pathMapStoreProperties) {
  ...
  private void clearCache() { CacheServiceLoader.shutdown(); }

  private void clearLibrary() { HashMapGraphLibrary.clear(); }

  @Test
  public void
  shouldGetAllElementsWhileHasConflictingSchemasDueToDiffVertexSerialiser()
      throws OperationException {
    // given
    ...
    try {
      ...
      assertTrue(
          ...
          Pattern
              .compile(
                  "Unable to merge the schemas for all of your federated graphs: \\[graph., graph.\\]\\. You can limit which graphs to query for using the operation option: gaffer\\.federatedstore\\.operation\\.graphIds")
              .matcher(e.getMessage())
              .matches());
    }

    // when
    final CloseableIterable<? extends Element> responseGraphsWithNoView =
        store.execute(new GetAllElements.Builder().build(), userContext);
    // then
  ...
  @Test
  public void
  shouldGetAllElementsFromSelectedRemoteGraphWhileHasConflictingSchemasDueToDiffVertexSerialiser()
      throws OperationException {
    // given
    final Entity A = getEntityA();
    final Entity B = getEntityB();
    ...
    // when
    final CloseableIterable<? extends Element> responseGraphA = store.execute(
        new GetAllElements.Builder()
            .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                    "graphA")
            .build(),
        userContext);
    final CloseableIterable<? extends Element> responseGraphB = store.execute(
        new GetAllElements.Builder()
            .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                    "graphB")
            .build(),
  ...
  @Test
  public void
  shouldGetAllElementsFromSelectedGraphsWithViewOfExistingEntityGroupWhileHasConflictingSchemasDueToDiffVertexSerialiser()
      throws OperationException {
    // given
    final Entity A = getEntityA();
    final Entity B = getEntityB();
    ...
    // when
    final CloseableIterable<? extends Element> responseGraphAWithAView =
        store.execute(
            new GetAllElements.Builder()
                .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                        "graphA")
                .view(new View.Builder().entity("entityA").build())
                .build(),
            userContext);
    final CloseableIterable<? extends Element> responseGraphBWithBView =
        store.execute(
            new GetAllElements.Builder()
                .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                        "graphB")
                .view(new View.Builder().entity("entityB").build())
                .build(),
            userContext);
    final CloseableIterable<? extends Element> responseAllGraphsWithAView =
        store.execute(
            new GetAllElements.Builder()
                .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                        "graphA,graphB")
                ...
                .build(),
            userContext);
    final CloseableIterable<? extends Element> responseAllGraphsWithBView =
        store.execute(
            new GetAllElements.Builder()
                .option(FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
                        "graphA,graphB")
  ...
  @Test
  public void
  shouldFailGetAllElementsFromSelectedGraphsWithViewOfMissingEntityGroupWhileHasConflictingSchemasDueToDiffVertexSerialiser()
      throws OperationException {
    // given
    final Entity A = getEntityA();
    final Entity B = getEntityB();
    ...
    try {
      // when
      CloseableIterable<? extends Element> responseGraphAWithBView =
          store.execute(
              new GetAllElements.Builder()
                  .option(
      ...
      assertEquals(
          "Operation chain is invalid. Validation errors: \n"
              ...
              + "Entity group entityB does not exist in the schema",
          e.getMessage());
    }

    try {
      // when
      final CloseableIterable<? extends Element> responseGraphBWithAView =
          store.execute(
              new GetAllElements.Builder()
                  .option(
                      FederatedStoreConstants.KEY_OPERATION_OPTIONS_GRAPH_IDS,
      ...
      assertEquals(
          "Operation chain is invalid. Validation errors: \n"
              ...
              +
              "View for operation uk.gov.gchq.gaffer.operation.impl.get.GetAllElements is not valid. \n"
              + "Entity group entityA does not exist in the schema",
          e.getMessage());
    }

    addGraphWithPaths("graphC", PATH_ACC_STORE_PROPERTIES_1,
                      PATH_ENTITY_B_SCHEMA_JSON);
  ...
  protected void addElementsToNewGraph(final Entity input,
                                       final String graphName,
                                       final String pathSchemaJson)
      throws OperationException {
  ...
  protected Entity getEntityA() {
    return new Entity.Builder().group("entityA").vertex("A").build();
  }
}
